...
<body>
	...
	<section>
		<article id="html" class="relative">
			<h2 class="h2-title">
				웹클라이언트의 시작. <span class="h2-title-gray">HTML/CSS</span>
			</h2>
			...
			for (VideoListDto vldto : videoList) {
				%>
					<div class="url-card">
						<a
							href="education-page.jsp?title=<%=vldto.getTitle()%>&content=<%=vldto.getDescription()%>&url=<%=vldto.getUrl()%>&lang=<%=vldto.getCategory_id()%>">
							<!-- ######### java 코드 삽입 영역#######--> <!-- title --> <span
							class="url-title"><%= vldto.getTitle() %></span> <!-- content -->
							<span class="url-content"><%= vldto.getDescription() %></span> <!-- url -->
							<embed controls=0
								src="https://img.youtube.com/vi/<%= vldto.getUrl() %>/maxresdefault.jpg"
	...
	<section>
		<article id="script" class="relative">
			<h2 class="h2-title">
				동적인 웹페이지를 구현.<span class="h2-title-gray"> JavaScript</span>
			</h2>
			<div class="scroll-box">
				<img src="./img/scroll-left.png" class="scroll-img left hidden">
				<img src="./img/scroll-rt.png" class="scroll-img right">
			...
			for (VideoListDto vldto2 : videoList2) {
				%>
					<div class="url-card">
						<a
							href="education-page.jsp?title=<%=vldto2.getTitle()%>&content=<%=vldto2.getDescription()%>&url=<%=vldto2.getUrl()%>&lang=<%=vldto2.getCategory_id()%>">
							<!-- ######### java 코드 삽입 영역#######--> <!-- title --> <span
							class="url-title"><%= vldto2.getTitle() %></span> <!-- content -->
							<span class="url-content"><%= vldto2.getDescription() %></span> <!-- url -->
							<embed controls=0
								src="https://img.youtube.com/vi/<%= vldto2.getUrl() %>/maxresdefault.jpg"
								allowfullscreen></embed>
						</a>
					</div>
					<%
	...
	<section>
		<article id="database" class="relative">
			<h2 class="h2-title">
				관계형 데이터 베이스의 시작.<span class="h2-title-gray"> DataBase</span>
			</h2>
			<div class="scroll-box">
				<img src="./img/scroll-left.png" class="scroll-img left hidden">
				<img src="./img/scroll-rt.png" class="scroll-img right">
			...
			for (VideoListDto vldto3 : videoList3) {
				%>
					<div class="url-card">
						<a
							href="education-page.jsp?title=<%=vldto3.getTitle()%>&content=<%=vldto3.getDescription()%>&url=<%=vldto3.getUrl()%>&lang=<%=vldto3.getCategory_id()%>">
							<!-- ######### java 코드 삽입 영역#######--> <!-- title --> <span
							class="url-title"><%= vldto3.getTitle() %></span> <!-- content -->
							<span class="url-content"><%= vldto3.getDescription() %></span> <!-- url -->
							<embed controls=0
								src="https://img.youtube.com/vi/<%= vldto3.getUrl() %>/maxresdefault.jpg"
								allowfullscreen></embed>
						</a>
					</div>
					<%}%>
	...
	<section>
		<article id="jsp" class="relative">
			<h2 class="h2-title">
				웹 애플리케션 개발의 기초.<span class="h2-title-gray"> JSP</span>
			</h2>
			<div class="scroll-box">
				<img src="./img/scroll-left.png" class="scroll-img left hidden">
				<img src="./img/scroll-rt.png" class="scroll-img right">
			...
			for (VideoListDto vldto4 : videoList4) {
				%>
					<div class="url-card">
						<a
							href="education-page.jsp?title=<%=vldto4.getTitle()%>&content=<%=vldto4.getDescription()%>&url=<%=vldto4.getUrl()%>&lang=<%=vldto4.getCategory_id()%>">
							<!-- ######### java 코드 삽입 영역#######--> <!-- title --> <span
							class="url-title"><%= vldto4.getTitle() %></span> <!-- content -->
							<span class="url-content"><%= vldto4.getDescription() %></span> <!-- url -->
							<embed controls=0
								src="https://img.youtube.com/vi/<%= vldto4.getUrl() %>/maxresdefault.jpg"
								allowfullscreen></embed>
						</a>
					</div>
					<%}%>
	...
	<section>
		<article id="spring" class="relative">
			<h2 class="h2-title">
				Java를 기반으로 한 오픈 소스 프레임워크.<span class="h2-title-gray"> Spring</span>
			</h2>
			<div class="scroll-box">
				<img src="./img/scroll-left.png" class="scroll-img left hidden">
				<img src="./img/scroll-rt.png" class="scroll-img right">
			...
			for (VideoListDto vldto5 : videoList5) {
				%>
					<div class="url-card">
						<a
							href="education-page.jsp?title=<%=vldto5.getTitle()%>&content=<%=vldto5.getDescription()%>&url=<%=vldto5.getUrl()%>&lang=<%=vldto5.getCategory_id()%>">
							<!-- ######### java 코드 삽입 영역#######--> <!-- title --> <span
							class="url-title"><%= vldto5.getTitle() %></span> <!-- content -->
							<span class="url-content"><%= vldto5.getDescription() %></span> <!-- url -->
							<embed controls=0
								src="https://img.youtube.com/vi/<%= vldto5.getUrl() %>/maxresdefault.jpg"
								allowfullscreen></embed>
						</a>
					</div>
					<%}%>
